 ...
 */
const obtenerTelefonoPeru = function (econtact = {}) {
    if (typeof econtact.datos?.sedes?.Peru?.telefono === "undefined") {
        return "Perú no tiene asignado un teléfono";
    }

    const telefono = econtact.datos.sedes.Peru.telefono;
    return `El teléfono de Perú es: ${telefono}`;
}
...
const objetoFijo = {
  ...
  const res = obtenerTelefonoPeru(objetoFijo);
  console.log(res);